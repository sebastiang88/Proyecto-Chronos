    ...
    <!--formulario-->
        <div class="grid grid-cols-2 gap-x-8 gap-y-4 p-4 mt-8 max-w-xl mx-auto">
            ...
            <div class="col-span-2"> 
                ...
                <textarea
                    v-model="form.salud.descripcion"
                    id="descripcion"
                    name="descripcion"
                ...
                <div class="w-80">
                    ...
                    <div class="flex items-center justify-center space-x-6 mt-2">
                        <label class="inline-flex items-center cursor-pointer">
                            <input 
                                v-model="form.salud.notificaciones"
                                type="checkbox" 
                                id="notificaciones"
                                name="notificaciones"
                                class="sr-only peer"
...
// Objeto del formulario — conectar al backend con form.value.salud
const form = ref({
    salud: {
        titulo: '',
        tipo: '',     
...
const navigateToSectionHealth = () => {
    ...
    // await api.post('/recordatorios/salud', form.value.salud)
    console.log('Datos a enviar:', form.value.salud)
